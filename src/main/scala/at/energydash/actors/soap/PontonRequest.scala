...
import soapenvelope11.{Body, Envelope}

import java.net.URI
import scala.concurrent.{ExecutionContext, Future}
import scala.xml.NamespaceBinding

trait OutboundDocument4SOAPBindings {
  this: scalaxb.Soap11ClientsAsync with scalaxb.HttpClientsAsync =>
...
class PontonRequest(system: ActorSystem[_]) extends OutboundDocument4SOAPBindings with Soap11ClientsAsync {
