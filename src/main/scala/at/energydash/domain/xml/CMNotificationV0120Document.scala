...
import cmnotification.v01p20.CMNotification

class CMNotificationV0120Document(doc: CMNotification) {
...
object CMNotificationV0120Document {
  def apply(doc: CMNotification): CMNotificationV0120Document = new CMNotificationV0120Document(doc)
}