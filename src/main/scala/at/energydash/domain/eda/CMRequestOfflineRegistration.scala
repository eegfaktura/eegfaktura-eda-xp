...
import at.energydash.domain.xml.{CMRequestV0120Document,CMRequestV0121Document}
import cmrequest._
import ponton.`package`.{Cmrequestv01p20_CMRequestFormat, Cmrequestv01p21_CMRequestFormat}
